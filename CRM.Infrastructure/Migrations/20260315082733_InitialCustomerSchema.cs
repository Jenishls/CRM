...
namespace CRM.Infrastructure.Migrations
{
    ...
    public partial class InitialCustomerSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerIdentityDocuments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerIdentityDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerIdentityDocuments_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerIdentityDocuments_CustomerId",
                table: "CustomerIdentityDocuments",
                column: "CustomerId");
        }
